...
#read all 3 users' inputs and index them
def index_all_inputs
  #read user0's inputs and index them
  File.foreach "kbd_mouse_data0.txt" do |line|
	line = line.chomp
  ...
  #read user1's inputs and index them
  File.foreach "kbd_mouse_data1.txt" do |line|
	line = line.chomp
	if !$unique_all_seq.include?(line)
	  $unique_all_seq << line
	end
  ...
  #read user2's inputs and index them
  File.foreach "kbd_mouse_data2.txt" do |line|
	line = line.chomp
	if !$unique_all_seq.include?(line)
	  $unique_all_seq << line
	end
...
for i in 0...10
  u0.test($user0_seq[(50 * i)...(50 * (i + 1))])
  newfile.puts u0.printProb
end

for i in 0...40
  u0.test($user1_seq[(50 * i)...(50 * (i + 1))])
  newfile.puts u0.printProb
end

for i in 0...40
  u0.test($user2_seq[(50 * i)...(50 * (i + 1))])
  newfile.puts u0.printProb
end
...
for i in 0...10
  u0.test($user0_seq[(500 + 50 * i)...(500 + 50 * (i + 1))])
  newfile.puts u0.printProb
end
...
for i in 0...10
  u0.test($user0_seq[(1000 + 50 * i)...(1000 + 50 * (i + 1))])
  newfile.puts u0.printProb
end
...
for i in 0...10
  u0.test($user0_seq[(1500 + 50 * i)...(1500 + 50 * (i + 1))])
  newfile.puts u0.printProb
end
...
for i in 0...10
  u0.test($user1_seq[(500 + 50 * i)...(500 + 50 * (i + 1))])
  newfile.puts u0.printProb
end
...
for i in 0...10
  u0.test($user1_seq[(1000 + 50 * i)...(1000 + 50 * (i + 1))])
  newfile.puts u0.printProb
end
...
for i in 0...10
  u0.test($user1_seq[(1500 + 50 * i)...(1500 + 50 * (i + 1))])
  newfile.puts u0.printProb
end
...
for i in 0...10
  u0.test($user2_seq[(500 + 50 * i)...(500 + 50 * (i + 1))])
  newfile.puts u0.printProb
end
...
for i in 0...10
  u0.test($user2_seq[(1000 + 50 * i)...(1000 + 50 * (i + 1))])
  newfile.puts u0.printProb
end
...
for i in 0...10
  u0.test($user2_seq[(1500 + 50 * i)...(1500 + 50 * (i + 1))])
  newfile.puts u0.printProb
end
